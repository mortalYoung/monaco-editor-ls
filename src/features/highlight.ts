...
monaco.languages.setLanguageConfiguration("SparkSQL", {
  comments: {
    lineComment: "--",
    blockComment: ["/*", "*/"],
  },
...
//   )
// );
// const regex2 = createRegExp(exactly("--").and(oneOrMore(char)));
// const regex3 = createRegExp(oneOrMore(word).before("("));
// const regex4 = createRegExp(
//   exactly("'")
